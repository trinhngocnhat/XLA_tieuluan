...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        self.spacer = QtWidgets.QLabel(self.frame_2)
        self.spacer.setGeometry(QtCore.QRect(790, 610, 211, 151))  # Điều chỉnh vị trí và kích thước cho phù hợp
        self.spacer.setStyleSheet("background-color: rgb(255, 255, 255);")  # Hoặc bất kỳ màu nào bạn muốn
